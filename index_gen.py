              ...
              <div class="col-md-7">
                <div class="row">
                    <horizontal-padding>
                      ...
                      <p>
                        Prof. Meng has published 30+ publications in prestigious journals
                        such as <i>Nature, Physical Review Letters, PNAS, PNAS Nexus, Science Advances, Nature Human Behaviour,
                        ...
                        He has reviewed 60+ papers from the above journals and <i>Europhysics Letters,
                        New Journal of Physics, Magnetic Resonance in Medicine, Journal of Business Research,</i> etc.
