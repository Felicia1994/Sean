              ...
              <div class="col-md-7">
                <div class="row">
                    <horizontal-padding>
                      ...
                      <p>
                        Prof. Meng has published in prestigious journals such as
                        <i>Nature, PNAS, PNAS Nexus, Science Advances, Nature Human Behaviour,
                        Nature Communications, Physical Review Letters,</i>
                        and <i>Physical Review D.</i>
                        Prof. Meng is an affiliated faculty member with the NITMB in Chicago
                        and a principal investigator with the Co-design Center for Quantum Advantage (C2QA).
                        His research is funded by multiple agencies,
                        including the DOE, IBM, and the Templeton Foundation.
                      </p>
                    </horizontal-padding>
                </div>
              </div>
